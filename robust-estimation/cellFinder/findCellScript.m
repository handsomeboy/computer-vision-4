...
run('C:\Users\Tan\Documents\MATLAB\matlabVisTools\matlab\startup.m');
...
hmdir = 'C:\Users\Tan\Documents\MATLAB\A2handout\cellFinder\';

% Link the other handout directories for A2
addpath([hmdir,'circleFit/']);
addpath([hmdir 'util/']);
addpath([hmdir '../data/']);
addpath(['C:\Users\Tan\Documents\MATLAB\matlabVisTools\matlab\utvisToolbox\edge\']); % For cannyEdgels.m
...
sigmaGM = 80; % Geman-McLure estimator scale parameter

% Additional parameters (you do not need to set)
numGuesses = 15;   % Number of circles proposals, if possible
maxNumTrials = 15; % Max number of propose-fit-check loops
...
for iFname = 1:n  % Use 1 image for now, change to 1:nFname to process all
